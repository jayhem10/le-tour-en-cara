...
export function Hero() {
  return (
    <section id="top" className="relative overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-[65vh] max-w-6xl flex-col justify-end gap-6 px-4 pb-16 pt-32 sm:min-h-[92vh] sm:px-6">
        ...
        <p className="max-w-xl text-lg text-cream/90 drop-shadow-md">{siteConfig.general.description}</p>
      </div>
